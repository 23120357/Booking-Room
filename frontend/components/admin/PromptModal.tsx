...
export default function PromptModal({
  ...
  const actualPlaceholder = placeholder || t.admin.promptModal.placeholder;
  const actualConfirmText = confirmText || t.admin.promptModal.confirm;
  const actualCancelText = cancelText || t.admin.promptModal.cancel;
  ...
  const handleConfirm = () => {
    if (!value.trim()) {
      setError(t.admin.promptModal.emptyError);
      return;
    }
    onConfirm(value);
  };
